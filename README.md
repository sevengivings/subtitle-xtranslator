...
## [최신 버전업 내용]
- 2023-11-17 app.py의 웹 화면 구성을 변경하고, 여러 개의 MP3를 처리할 수 있게 하였습니다. 진행률 표시는 리눅스(WSL에서 테스트)에서만 작동하며, 현재 Colab에서는 진행률 표시도 안되고 처리가 끝난 후에도 종료가 안되는 문제가 있습니다. Colab은 다음 버전을 기다려 주세요... 
